...
public class HyFlowLayout extends ViewGroup {


    public HyFlowLayout(Context context) {
        super(context);
    }

    public HyFlowLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HyFlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
